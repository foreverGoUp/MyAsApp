...
public class ScreenUtils {
     ...
     *
     * @param context 上下文
     * @return 屏幕密度, 值为0.75, 1, 1.5, 2, etc。常用作px与dp转换的关键值，适合适配各种像素的手机。
     * <p/>
     * 120dpi:160:240:320:480:640 = 0.75:1:1.5:2:3:4
     * <p/>
     * 对于320dpi的手机，1dp = 2px，其他dpi手机依此类推
     * dp值可以使图片在不同手机上显示一样的大小，而单纯使用px的自定义view会出现适配问题
     */
