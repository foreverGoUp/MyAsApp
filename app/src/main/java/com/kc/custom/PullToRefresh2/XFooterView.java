package com.kc.custom.PullToRefresh2;
...
//                mHintView.setText("加载更多");
                mHintView.setText(getContext().getResources().getString(R.string.load_mode_label));
                break;
...
//                    mHintView.setText("释放加载更多");
                    mHintView.setText(getContext().getResources().getString(R.string.log_release_to_load_more));
                }
                break;
